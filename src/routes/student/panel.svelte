<script>
	...
	const validPersonalEmail = async(target)=>{
		...
		/*if(v){
			...
			const resp = await axiosapi.doPost('/student/verify/existence', obj).then((res)=>{
				return res.data
			}).catch(() => {
				swal.err()
			})
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" id="grade">
                                                <option value="0">Selecciona tu grado...</option>
                                                {#each grades as item}
                                                    <option value="0">0</option>
                                                {/each}
                                            </select>
                                            {#each fbGrade as item}
                                                <div class="invalid-feedback">
                                                    {item}
                                                </div>
                                            {/each}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input bind:this="{elementGroup}" autocomplete="off" class="form-control" type="text" id="personal_email" placeholder="Grupo">
                                            {#each fbGroup as item}
                                                <div class="invalid-feedback">
                                                    {item}
                                                </div>
                                            {/each}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" id="division">
                                                <option value="0">Selecciona tu división...</option>
                                                {#each divisions as item}
                                                    <option value="0">0</option>
                                                {/each}
                                            </select>
                                            {#each fbDivision as item}
                                                <div class="invalid-feedback">
                                                    {item}
                                                </div>
                                            {/each}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" id="level">
                                                <option value="0">Selecciona tu nivel académico...</option>
                                                {#each levels as item}
                                                    <option value="0">0</option>
                                                {/each}
                                            </select>
                                            {#each fbLevel as item}
                                                <div class="invalid-feedback">
                                                    {item}
                                                </div>
                                            {/each}
